...
void run_ex01_02() {
	...
	cout << "ans1 : " << "(" << a1.x << "," << a1.y << "," << a1.z << "," << a1.w << ")" << endl;
	cout << "ans2 : " << "(" << a2.x << "," << a2.y << "," << a2.z << "," << a2.w << ")" << endl;
	cout << "ans3 : " << "(" << a3.x << "," << a3.y << "," << a3.z << "," << a3.w << ")" << endl;
	cout << "ans4 : " << "(" << a4.x << "," << a4.y << "," << a4.z << "," << a4.w << ")" << endl;
